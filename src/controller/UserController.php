...
class UserController
{
    ...
    public function delete(): void
    {
        ...
        try {
            $stmt = $this->conn->prepare("DELETE FROM Usuario WHERE email=:username");
    ...
    public function login(): void
    {
        ...
        $stmt = $this->conn->prepare("SELECT email, password, admin FROM users WHERE email=:username");
        $stmt->bindParam(':username', $username, PDO::PARAM_STR);
        $stmt->execute();

        // Obtenemos los resultados de la consulta y lo almacenamos en $users en un array associativo.
